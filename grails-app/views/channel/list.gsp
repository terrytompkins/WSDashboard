                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="description" title="${message(code: 'channel.description.label', default: 'Description')}" />
                        
                            <g:sortableColumn property="displayOrder" title="${message(code: 'channel.displayOrder.label', default: 'Display Order')}" />
                        
                            <g:sortableColumn property="lastUpdated" title="${message(code: 'channel.lastUpdated.label', default: 'Last Updated')}" />
                        
                            <th><g:message code="channel.modifiedBy.label" default="Modified By" /></th>
                    ...
                    <g:each in="${channelInstanceList}" status="i" var="channelInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: channelInstance, field: "description")}</td>
                        
                            <td>${fieldValue(bean: channelInstance, field: "displayOrder")}</td>
                        
                            <td><g:formatDate date="${channelInstance.lastUpdated}" /></td>
                        
                            <td>${fieldValue(bean: channelInstance, field: "modifiedBy")}</td>
