            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="region.displayOrder.label" default="Display Order" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: regionInstance, field: "displayOrder")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="region.modifiedBy.label" default="Modified By" /></td>
                            
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${regionInstance?.modifiedBy?.id}">${regionInstance?.modifiedBy?.encodeAsHTML()}</g:link></td>
